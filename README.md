...
2. [Apache Spark plugin](https://spark.apache.org/docs/latest/api/java/index.html?org/apache/spark/api/plugin/SparkPlugin.html) implementation - which allows to start the agent on every node, while attaching a context to the profiling data in runtime. 
